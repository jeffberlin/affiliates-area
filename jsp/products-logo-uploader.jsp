            ...
            <div class="col-lg-10 col-md-12 page-title">
              ...
              <div class="content-box">
                <div class="text-center" style="margin-bottom: 1rem;">
                  <img src="https://affiliates-new.bmtmicro.com/servlets/Affiliates.LogoImage?DEFAULT=https://secure.bmtmicro.com/Templates/TestLogo.png&AID=${requestScope.AID}" style="margin-bottom: 1rem;" />
                  <form name="LogoForm" enctype="multipart/form-data" method="post" action="https://affiliates-new.bmtmicro.com/servlets/Affiliates.LogoImage">
                    <input type="hidden" name="NEXT_PAGE" value="https://affiliates-new.bmtmicro.com/products-logo-uploader.jsp" />
