        ...
        <article class="section">
          <div class="row justify-content-start">
            ...
            <div class="col-lg-10 col-md-12 page-title">
              ...
              <p>This form is for new affiliates only. If you have previously signed up to be a BMT Micro Affiliate, please login <a href="https://affiliates-new.bmtmicro.com">here</a>. If you do not know how to log in, please contact our webmaster.</p>
              <p>Please read our <a href="https://affiliates-new.bmtmicro.com/NewSignup/affiliate-terms.jsp" target="_blank">Affiliate Terms</a>, then choose your Login Name and Password.</p>
              <form name="form1" method="post" action="https://affiliates-new.bmtmicro.com/servlets/Affiliates.Signup">
                <input type="hidden" name="NEXT_PAGE" value="https://affiliates-new.bmtmicro.com/affiliate-signup-info.jsp" />
