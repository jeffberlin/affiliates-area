        ...
        <div class="row justify-content-center">
          <div class="box-style">
            <div class="affiliate-login-box" style="background-color: rgba(255, 255, 255, 0.3);">
              <form action="https://affiliates-new.bmtmicro.com/servlets/Affiliates.ResetPassword" method="post">
                <input type="hidden" name="NEXT_PAGE" value="https://affiliates-new.bmtmicro.com/login_resetlinksent.html">
                <input type="hidden" name="RESET_PAGE" value="https://affiliates-new.bmtmicro.com/login_resetpassword.html">
                <input type="hidden" name="ERROR_PAGE" value="https://affiliates-new.bmtmicro.com/login_lostpassworderror.html">
