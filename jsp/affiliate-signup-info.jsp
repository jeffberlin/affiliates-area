            ...
            <div class="col-lg-10 col-md-12 page-title">
              ...
              <div class="content-box overflow-auto">
                <form name="form1" method="post" action="https://affiliates-new.bmtmicro.com/servlets/Affiliates.Account">
                  ...
                  <input type="hidden" name="ERROR_PAGE" value="https://affiliates-new.bmtmicro.com/affiliate-signup-error.jsp" />
                  <input type="hidden" name="EMAILTEMPLATE" value="https://affiliates-new.bmtmicro.com/newaffiliate.txt" />
                  <span>
                  ...
                  <span>
                    ...
                    <img class="popup" title="Name of the company who develops the product." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>Contact Name:&nbsp;</label>
                    <input name="NAME" class="textfield3" size="30" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="Name of the Developer or Contact person." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>Company Address:&nbsp;</label>
                    <input name="ADDRESS1" class="textfield3" size="30" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title=" complete company (or individual) mailing address." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>Address 2:&nbsp;</label>
                    <input name="ADDRESS2" class="textfield3" size="30" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="Second line of mailing address, if necessary." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>City:&nbsp;</label>
                    <input name="CITY" class="textfield3" size="30" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="Your city" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" style="margin-right: 1.5rem;" />
                  </span>
                  <span>
                    ...
                    <img class="popup" title="Select State or Province" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>ZIP/Postal Code:&nbsp;</label>
                    <input name="ZIP" class="textfield3" size="15" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="ZIP/Postal Code" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" style="margin-right: 1.5rem;" />
                  </span>
                  <span>
                    <label>Country:&nbsp;</label>
                    ...
                    <img class="popup" title="Please select your Country" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  ...
                  <span>
                    ...
                    <img class="popup" title="Email address where we can contact you." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>Phone:&nbsp;</label>
                    <input name="PHONE" class="textfield3" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="Your information is not given out to the customer." src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" style="margin-right: 1.5rem;" />
                  </span>
                  <span>
                    <label>Fax:&nbsp;</label>
                    <input name="FAX" class="textfield3" style="margin-bottom: 1rem;" />&nbsp;
                    <img class="popup" title="Fax number, if available" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
                  <span>
                    <label>Website Address:&nbsp;</label>
                    <input name="WEBADDRESS" class="textfield3" size="35" style="margin-bottom: 2rem;" />&nbsp;
                    <img class="popup" title="Web address representing your company or products" src='<c:url value="https://affiliates-new.bmtmicro.com/images/questionMark.gif"></c:url>' alt="Question mark" />
                  </span>
                  <br>
