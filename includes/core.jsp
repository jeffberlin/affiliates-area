...
<c:set var="flags" value="${cookie['BMTMicro.Affiliates.Flags'].value}" /><c:if test="${flags == null}"><c:set var="flags" value="0"/></c:if><c:if test="${flags == -1}"><c:set var="flags" value="4294967295"/></c:if>
