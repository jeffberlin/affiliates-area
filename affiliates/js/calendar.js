...
function cal_popup1 (str_datetime) {
	...
	var obj_calwindow = window.open(
		'https://affiliates.bmtmicro.com/calendar.html?datetime=' + this.dt_current.valueOf()+ '&id=' + this.id,
		'Calendar', 'width=275,height='+(this.time_comp ? 275 : 225)+
...
function cal_prs_date1 (str_date) {
	...
	var dt_numdays = new Date(arr_date[0], arr_date[1], 2);
